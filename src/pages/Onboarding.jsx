...
const OnBoarding = () => {
  ...
  return (
    <div className='flax flex-col items-center justify-center mt-32'>
      <h2 className='gradient-title font-extrabold text-7xl sm:text-8xl tracking-tighter text-center'>
        I am a...</h2>
